...
def main():
    try:
        ...
        # Início da correção para a barra de rolagem: encapsula o conteúdo em uma div rolável
        st.markdown("<div class='app-container'>", unsafe_allow_html=True)

        # Renderiza a barra lateral com a navegação
        with st.sidebar:
            if user.role == "SEDE":
        ...
        # Fim da correção para a barra de rolagem: fecha a div rolável
        st.markdown("</div>", unsafe_allow_html=True)
