...
def page_relatorio_entrada(user: "User"):
    ...
    with SessionLocal() as db:
        ...
        # salvar no banco (com equivalência de dízimos)
        def _save_sum():
        ...
        if isinstance(edited, pd.DataFrame) and not edited.empty and ("Data do Culto" in edited.columns):
            ...
            st.button("🗑️ Apagar linhas selecionadas", type="secondary",
                      on_click=_delete_selected_rows, key="btn_del_entrada_sum")
