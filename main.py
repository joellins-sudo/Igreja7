# main.py — Igreja Finance CHMS — v8.51 (Pesquisa de
# Dizimistas por nome/congregação/mês)
 
...
.btn-green button{ background: linear-gradient(180deg,#22c55e,#16a34a)!important;
border-color:#16a34a!important; color:#fff!important; }
.btn-red    button{ background: linear-gradient(180deg,#ef4444,#dc2626)!important;
...
 
# ATENÇÃO: a linha abaixo deve ser movida para dentro da função main()
...
def main():
    try:
        # AQUI É O LUGAR CERTO para criar as tabelas
        Base.metadata.create_all(engine)
        
        with SessionLocal() as db:
           ensure_seed()
