...
def page_lancamentos(user: "User"):
    ...
    with SessionLocal() as db:
        ...
        st.info(f"Exibindo e editando dados de: **{contexto_selecionado}**")
        ref_tab = get_month_selector("Mês de referência")
        start_tab, end_tab = month_bounds(ref_tab)
        
        # --- Seção 1: Formulários para Lançamento Rápido ---
        ...
        # --- Seção 2: Tabelas para Edição em Massa ---
        ...
        st.caption("Adicione ou edite linhas para cada culto (ex: 'Manhã', 'Noite'). Os dízimos nominais são lançados na tabela específica abaixo.")
